    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-950 to-slate-900 p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md z-10">
        <div className="text-center mb-8 space-y-2">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white font-[Outfit]">Crie sua conta</h1>
          <p className="text-slate-400">Junte-se ao ChatApp e comece a conversar</p>
        </div>
